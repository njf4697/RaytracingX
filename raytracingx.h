...
struct { //struct to contain information for the initial conditions for a geodesic
...
struct { //struct that contains information about the metric interpolated at a point
...
//scheduled
extern "C" void createImage(CCTK_ARGUMENTS); //createImage.cc
